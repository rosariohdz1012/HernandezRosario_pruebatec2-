                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            %>                            
                            <form action="<%=request.getContextPath()%>/Cita?accion=modificarCita" method="post">
                                <div class="mb-3">
                                    <label for="fechaCita" class="form-label">Fecha de la Cita</label>
                                    <input type="date" class="form-control" id="fechaCita" name="fechaCita" value="<%=cita.getFechaCita()%>" required>
                                </div>
                                <div class="mb-3">
                                    <label for="horaCita" class="form-label">Hora de la Cita</label>
                                    <input type="time" class="form-control" id="horaCita" name="horaCita" value="<%=cita.getHoraCita()%>" required>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                    <label class="form-label">Estado de tramite</label>
                                    <div>
                                        
                                        <div class="form-check form-check-inline">
                                            <%if(cita.getEstado()== 0){%>
                                            <input class="form-check-input" type="radio" id="espera" name="estado" value="0"
                                                   checked="checked" required>
                                            <%}else{%>
                                             <input class="form-check-input" type="radio" id="espera" name="estado" value="0"
                                                    required>
                                             <%}%>
                                            <label class="form-check-label" for="espera">Espera</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <%if(cita.getEstado()== 1){%>
                                            <input class="form-check-input" type="radio" id="atendido" name="estado" value="1"
                                                checked="checked"  required>
                                            <%}else{%>
                                            <input class="form-check-input" type="radio" id="atendido" name="estado" value="1"
                                                 required>
                                ...
                                <a href="<%=request.getContextPath()%>/Cita" class="btn btn-secondary">Cancelar</a>
                            </form>
                        </div>
                    </div>
                </div>
