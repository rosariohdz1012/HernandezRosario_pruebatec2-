                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            %>
                            <form action="<%=request.getContextPath()%>/Tramite?accion=modificarT" method="post" >
                                <div class="mb-3">
                                    <label for="nombre" class="form-label">Nombre</label>
                                    <input type="text" class="form-control" id="nombre" name="nombre" required value="<%=tramite.getNombre()%>">
                                </div>
                                <div class="mb-3">
                                    <label for="descripcion" class="form-label">Descripción</label>
                                    <input type="text" class="form-control" id="descripcion" name="descripcion" required value="<%=tramite.getDescripcionTra()%>">
                                </div>
                                <button type="submit" class="btn btn-primary">Editar</button>
                                <a href="<%=request.getContextPath()%>/Tramite" class="btn btn-secondary">Cancelar</a>
                            </form>
                        </div>
                    </div>
                </div>
