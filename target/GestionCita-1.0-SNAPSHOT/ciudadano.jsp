            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<%=request.getContextPath()%>/Ciudadano?accion=insertarC" method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="telefono" name="telefono" pattern="\d+" required>
                                </div>
